...
import { FaDiscord, FaBars, FaFacebookF, FaInstagram, FaTelegramPlane } from "react-icons/fa";
...
const NavbarComponent = () => {
  ...
  return (
    <>
      ...
      {/* Sticky Navbar */}
      <div className="sticky-navbar z-40">
...

            {
              user ? (
                <div className="relative">
                  ...
                  >
                    {/* Display the user's profile picture or default icon */}
                  ...
                  {isDropdownOpen && (
                    <div className="absolute right-10 mt-2 top-[] w-48 bg-[#282828] border rounded shadow-lg z-50">
                      <div className="flex items-center mt-2">
                        ...
                        <p className="text-white mt-2 ml-2">{profile ?`${profile.firstName} ${profile.lastName}` : user.username}</p>
                      </div>
                      <button
                        onClick={viewProfile}
                ...
                <Link
                  to="/login"
                  className="text-gray-300 font-bold bg-blue-800 hover:bg-blue-900 rounded px-4 py-2"
                >
                  Log In
                </Link>
              )}
